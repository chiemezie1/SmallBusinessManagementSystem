...
void test_generate_sales_report(void) {
    ...
    Order order1 = {0, 1, 1609459200, 100.00, "Completed"};
    Order order2 = {0, 2, 1609545600, 150.00, "Completed"};
    placeOrder(&order1);
    placeOrder(&order2);
...
void test_generate_profit_report(void) {
    ...
    Order order = {0, 1, 1609459200, 100.00, "Completed"};
    placeOrder(&order);

    InventoryItem item = {0, "Test Item", "Test Description", 50.00, 10};
